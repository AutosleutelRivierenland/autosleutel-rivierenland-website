...
function Brand() { return <a className="brand" href="#top"><div className="brand-icon">AS<span>R</span></div><div><b>AUTOSLEUTEL</b><small>RIVIERENLAND</small></div></a> }
...
export default function Home() {
  return <main>
    ...
    <header className="header"><div className="container nav-inner"><Brand/><nav><a href="#diensten">Diensten</a><a href="#werkwijze">Werkwijze</a><a href="#werkgebied">Werkgebied</a><a href="#zakelijk">Zakelijk</a><a href="#contact">Contact</a></nav><a className="nav-phone" href={tel}>06 48 65 92 79 <span>→</span></a></div></header>

    <section id="top" className="hero"><div className="hero-grid-bg"></div><div className="container hero-inner">
      <div className="hero-copy"><div className="eyebrow"><i></i> Uw autosleutelspecialist uit Tiel</div><h1>Uw autosleutel.<br/><span>Onze specialiteit.</span></h1><p>Autosleutel kwijt, buitengesloten of een extra sleutel nodig? <strong>Autosleutel Rivierenland</strong> helpt u professioneel weer op weg.</p><div className="actions"><a className="btn primary" href={tel}>Bel direct <b>→</b></a><a className="btn ghost" href={whatsapp} target="_blank" rel="noreferrer">WhatsApp <b>↗</b></a></div><div className="hero-trust"><span>✓ 1 jaar garantie</span><span>✓ Service op locatie</span><span>✓ Geen voorrijkosten binnen Tiel</span></div></div>
      <div className="hero-art"><div className="blue-orb"></div><div className="car-line"></div><div className="key-graphic"><div className="key-head"><span></span><span></span></div><div className="key-shaft"></div></div><div className="floating-card"><div className="live-dot"></div><div><b>Direct hulp nodig?</b><small>Bel of WhatsApp ons</small></div><a href={tel}>→</a></div></div>
