...
function Header() {
  return (
    <>
      <div className="announcement"><div className="container announce-inner"><span>Autosleutelspecialist uit Tiel</span><span>Ma–do 09:00–21:00 · vrijdag gesloten · za–zo 09:00–21:00</span></div></div>
      <header className="header">
        <div className="container nav-inner">
          ...
          <nav aria-label="Hoofdnavigatie">
            ...
            <a href="/vag-sleutelprogrammering">VAG specialist <i>⌄</i></a>
            <a href="/mercedes-contactslot">Mercedes specialist <i>⌄</i></a>
    ...
    <main id="top">
      ...
      <section className="specialists">
        <div className="container specialists-grid">
          <a className="specialist-card vag-card" href="/vag-sleutelprogrammering"><div className="specialist-copy"><label>VAG SPECIALIST</label><h2>VAG specialist</h2><p>Wij zijn gespecialiseerd in Volkswagen, Audi, SEAT en Škoda.</p><span className="specialist-btn">Meer over VAG&nbsp; →</span></div></a>
          <a className="specialist-card mercedes-card-home" href="/mercedes-contactslot"><div className="specialist-copy"><label>MERCEDES SPECIALIST</label><h2>Mercedes specialist</h2><p>Specialist in geschikte Mercedes-modellen en FBS3 contactslot-service.</p><span className="specialist-btn">Meer over Mercedes&nbsp; →</span></div></a>
        </div>
      </section>
